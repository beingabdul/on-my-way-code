...
DonutChart('.salesDonutToday', [30, 30, 40], '100%', 243, ['Revenue', 'Sales', 'Products'], ['#0091ED', '#00AAFF', '#FA8B0C'], "60%");
DonutChart('.salesDonutWeek', [30, 40, 30], '100%', 243, ['Revenue', 'Sales', 'Products'], ['#0091ED', '#00AAFF', '#FA8B0C'], "60%");
DonutChart('.salesDonutMonth', [40, 30, 30], '100%', 243, ['Revenue', 'Sales', 'Products'], ['#0091ED', '#00AAFF', '#FA8B0C'], "60%");
DonutChart('.performance_overview', [30, 30, 40], '100%', 225, ['Target', 'In Progress', 'Completed'], ['#0091ED', '#00AAFF', '#FA8B0C'], "80%");

/* Radial Chart */
function radialChart(idName, series, width, height = "270") {
    var optionRadial = {
        series: series,
        colors: ['#0091ED', '#00AAFF', '#FA8B0C'],
        chart: {
            width: width,
            height: height,
            type: 'radialBar',
